...
/**
 *
 * @param must 此参数是否是必须的
 * @param desciption 参数描述
 */
...
object Utils {
  ...
  def createTableSQL(tableName: String, comment: String, fields: List[TableField], lifecycle: Int) = {
